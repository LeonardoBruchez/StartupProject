    ...
    try {
      ...
      const message =
        error instanceof Error
          ? error.message
          : "Erro inesperado na geracao do material.";
      alert(message);
    } finally {
    ...
    <div className="container">
      <header>
        ...
        <p className="subtitle">
          Transforme seus planos de aula em resumos e provas inteligentes em
          segundos com o poder da IA.
        </p>
      </header>
          ...
          <>
            ...
            >
              {isGenerating ? (
                ...
                <>
                  <Sparkles size={20} />{" "}
                  {studyType === "summary" ? "Gerar Resumo" : "Gerar Perguntas"}
                </>
              )}
            </button>
          </>
              ...
              {result.type === "summary" ? (
                ...
                <>
                  {result.additionalInfo && (
                    <p className="questions-extra-info">
                      Contexto adicional: {result.additionalInfo}
                    </p>
                  )}
                  <p className="questions-meta">
                    Modo: {result.mode} | Dificuldade: {result.difficulty} |
                    Total: {result.questions.length} questoes
                  </p>
